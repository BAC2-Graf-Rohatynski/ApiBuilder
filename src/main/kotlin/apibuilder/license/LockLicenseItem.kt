...
class LockLicenseItem: ILicenseItem, LicenseResponse() {
    var id: Int = 0

    fun create(id: Int): LockLicenseItem {
        this.id = id
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): LockLicenseItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(command = LicenseDatabaseCommand.Lock.name)
    }
}