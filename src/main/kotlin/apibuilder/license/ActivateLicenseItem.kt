...
class ActivateLicenseItem: ILicenseItem, LicenseResponse() {
    var id: Int = 0

    fun create(id: Int): ActivateLicenseItem {
        this.id = id
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): ActivateLicenseItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(command = LicenseDatabaseCommand.Activate.name)
    }
}