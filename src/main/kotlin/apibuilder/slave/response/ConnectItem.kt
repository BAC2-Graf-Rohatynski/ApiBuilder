...
class ConnectItem: ISlaveResponseItem, SlaveResponse() {
    lateinit var slave: Slave

    fun create(slave: Slave): ConnectItem {
        this.slave = slave
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): ConnectItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(command = enumstorage.slave.SlaveResponse.Connect)
    }
}