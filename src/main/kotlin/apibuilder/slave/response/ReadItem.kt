...
class ReadItem: ISlaveResponseItem, SlaveResponse() {
    lateinit var slave: Slave

    fun create(slave: Slave): ReadItem {
        this.slave = slave
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): ReadItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(command = enumstorage.slave.SlaveResponse.Read)
    }
}