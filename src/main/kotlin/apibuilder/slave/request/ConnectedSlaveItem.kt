...
class ConnectedSlaveItem: ISlaveRequestItem, SlaveRequest() {
    ...
    override fun toObject(message: String): ConnectedSlaveItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(command = SlaveCommand.Connected)
    }
}