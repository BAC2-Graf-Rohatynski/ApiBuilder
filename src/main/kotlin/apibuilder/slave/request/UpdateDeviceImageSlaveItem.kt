...
class UpdateDeviceImageSlaveItem: ISlaveRequestItem, SlaveRequest() {
    lateinit var fileName: String
    lateinit var fileStream: ByteArray
    lateinit var ipAddress: String

    fun create(fileName: String, fileStream: ByteArray, ipAddress: String): UpdateDeviceImageSlaveItem {
    ...
    override fun toObject(message: String): UpdateDeviceImageSlaveItem {
