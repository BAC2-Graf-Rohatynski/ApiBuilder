...
class UpdateDeviceByIdItem: IDevice, DatabaseResponse() {
    lateinit var item: DeviceItem

    fun create(item: DeviceItem): UpdateDeviceByIdItem {
        this.item = item
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): UpdateDeviceByIdItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.UpdateDeviceById,
