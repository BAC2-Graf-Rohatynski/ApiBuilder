...
class DeleteTypeItem: IType, DatabaseResponse() {
    lateinit var item: TypeItem

    fun create(item: TypeItem): DeleteTypeItem {
        this.item = item
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): DeleteTypeItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.DeleteType,
