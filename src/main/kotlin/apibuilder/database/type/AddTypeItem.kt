...
class AddTypeItem: IType, DatabaseResponse() {
    lateinit var item: TypeItem

    fun create(item: TypeItem): AddTypeItem {
        this.item = item
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): AddTypeItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.AddType,
