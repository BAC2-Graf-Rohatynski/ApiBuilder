...
class AddGoboItem: IConfiguration, DatabaseResponse() {
    lateinit var item: GoboItem

    fun create(item: GoboItem): AddGoboItem {
        this.item = item
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): AddGoboItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.AddGobo,
