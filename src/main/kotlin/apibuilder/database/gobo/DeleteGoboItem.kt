...
class DeleteGoboItem: IConfiguration, DatabaseResponse() {
    lateinit var item: GoboItem

    fun create(item: GoboItem): DeleteGoboItem {
        this.item = item
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): DeleteGoboItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.DeleteGobo,
