...
class DeleteImageItem: IImage, DatabaseResponse() {
    lateinit var item: ImageItem

    fun create(item: ImageItem): DeleteImageItem {
        this.item = item
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): DeleteImageItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.DeleteImage,
