...
class AddImageItem: IImage, DatabaseResponse() {
    lateinit var item: ImageItem

    fun create(item: ImageItem): AddImageItem {
        this.item = item
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): AddImageItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.AddImage,
