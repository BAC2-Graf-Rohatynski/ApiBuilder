...
class CheckIfSlaveIsAvailableItem: IInformation, DatabaseResponse() {
    var ssid: Int = 0

    fun create(ssid: Int): CheckIfSlaveIsAvailableItem {
        this.ssid = ssid
        buildHeader()
        return this
    }
    ...
    override fun toJson(): String {
        val body = JSONObject().put(SlaveInformation.Ssid.name, ssid)
    ...
    override fun toObject(message: String): CheckIfSlaveIsAvailableItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.CheckIfSlaveIsAvailable,
