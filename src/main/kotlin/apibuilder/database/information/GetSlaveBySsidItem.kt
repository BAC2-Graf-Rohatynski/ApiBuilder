...
class GetSlaveBySsidItem: IInformation, DatabaseResponse() {
    var ssid: Int = 0

    fun create(ssid: Int): GetSlaveBySsidItem {
        this.ssid = ssid
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): GetSlaveBySsidItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.GetSlaveBySsid,
