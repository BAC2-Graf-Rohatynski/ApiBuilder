...
class GetNumberOfSlavesItem: IInformation, DatabaseResponse() {
    fun create(): GetNumberOfSlavesItem {
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): GetNumberOfSlavesItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.GetNumberOfSlaves,
