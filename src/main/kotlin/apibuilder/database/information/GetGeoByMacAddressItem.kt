...
class GetGeoByMacAddressItem: IInformation, DatabaseResponse() {
    lateinit var macAddress: String

    fun create(macAddress: String): GetGeoByMacAddressItem {
    ...
    override fun toObject(message: String): GetGeoByMacAddressItem {
