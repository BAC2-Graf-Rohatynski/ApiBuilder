...
class DeleteSlaveItem: IInformation, DatabaseResponse() {
    var ssid: Int = 0

    fun create(ssid: Int): DeleteSlaveItem {
        this.ssid = ssid
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): DeleteSlaveItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.DeleteSlave,
