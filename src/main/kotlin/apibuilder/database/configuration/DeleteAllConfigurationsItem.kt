...
class DeleteAllConfigurationsItem: IConfiguration, DatabaseResponse() {
    lateinit var show: String

    fun create(show: String): DeleteAllConfigurationsItem {
        this.show = show
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): DeleteAllConfigurationsItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.DeleteAllConfigurations,
