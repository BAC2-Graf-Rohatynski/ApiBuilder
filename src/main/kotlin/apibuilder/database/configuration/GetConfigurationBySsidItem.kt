...
class GetConfigurationBySsidItem: IConfiguration, DatabaseResponse() {
    lateinit var show: String
    var ssid: Int = 0

    fun create(show: String, ssid: Int): GetConfigurationBySsidItem {
        this.show = show
        this.ssid = ssid
        buildHeader()
        return this
    ...
    override fun toObject(message: String): GetConfigurationBySsidItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.GetConfigurationBySsid,
