...
class IsShowAvailableItem: IDdf, DatabaseResponse() {
    lateinit var show: String

    fun create(show: String): IsShowAvailableItem {
        this.show = show
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): IsShowAvailableItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.IsShowAvailable,
