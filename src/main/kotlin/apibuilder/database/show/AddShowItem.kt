...
class AddShowItem: IDdf, DatabaseResponse() {
    lateinit var show: String

    fun create(show: String): AddShowItem {
        this.show = show
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): AddShowItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.AddShow,
