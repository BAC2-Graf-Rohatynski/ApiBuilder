...
class AddColorItem: IColor, DatabaseResponse() {
    lateinit var item: ColorItem

    fun create(item: ColorItem): AddColorItem {
        this.item = item
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): AddColorItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.AddColor,
