...
class UpdateColorByIdItem: IColor, DatabaseResponse() {
    lateinit var item: ColorItem

    fun create(item: ColorItem): UpdateColorByIdItem {
        this.item = item
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): UpdateColorByIdItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.UpdateColorById,
