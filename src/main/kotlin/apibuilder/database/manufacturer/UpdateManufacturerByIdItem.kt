...
class UpdateManufacturerByIdItem: IManufacturer, DatabaseResponse() {
    lateinit var item: ManufacturerItem

    fun create(item: ManufacturerItem): UpdateManufacturerByIdItem {
        this.item = item
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): UpdateManufacturerByIdItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = DatabaseCommand.UpdateManufacturerById,
