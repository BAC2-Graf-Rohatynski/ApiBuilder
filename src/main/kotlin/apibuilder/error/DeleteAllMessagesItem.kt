...
class DeleteAllMessagesItem: IErrorItem, ErrorResponse() {
    fun create(): DeleteAllMessagesItem {
        buildHeader()
        return this
    }
    ...
    override fun toObject(message: String): DeleteAllMessagesItem {
        header = parseToHeaderObject(message = message)
        return this
    }

    override fun buildHeader() {
        this.header = apibuilder.error.header.Header().build(command = MessageCommand.DeleteAllMessages)
    }
}