...
class AliveRequestItem: ISynchItem, SynchResponse() {
    lateinit var ipAddress: String
    lateinit var identification: String
    var port: Int = 0

    fun create(ipAddress: String, identification: String, port: Int): AliveRequestItem {
    ...
    override fun toObject(message: String): AliveRequestItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = SynchRequest.Alive.name,
                ipAddress = ipAddress)
    }
}