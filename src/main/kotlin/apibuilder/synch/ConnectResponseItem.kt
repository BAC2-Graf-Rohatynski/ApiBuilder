...
class ConnectResponseItem: ISynchItem, SynchResponse() {
    lateinit var ipAddress: String
    lateinit var identification: String
    var port: Int = 0

    fun create(ipAddress: String, identification: String, port: Int): ConnectResponseItem {
    ...
    override fun toObject(message: String): ConnectResponseItem {
    ...
    override fun buildHeader() {
        this.header = Header().build(
                command = enumstorage.synch.SynchResponse.ConnectResponse.name,
                ipAddress = ipAddress)
    }
}